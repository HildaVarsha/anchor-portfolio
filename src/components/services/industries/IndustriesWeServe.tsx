    ...
    <div className="bg-white">
      <div className="px-4 md:px-0 md:container mx-auto py-12 text-slate-800">
        ...
        <p className="pt-4 text-lg" data-aos="fade-up">
          ...
          Informatics offers comprehensive geospatial solutions — a strategic,
          consultative approach designed to help companies excel with agility
          and trust in an ever-competitive landscape. Discover how these
          innovations can elevate your business to new heights.
        </p>
      </div>
    </div>
  );
